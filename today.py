...
USER_NAME = os.environ['USER_NAME'].strip() # 'zaidnfs'
...
if __name__ == '__main__':
    try:
        ...
        age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 8, 7))
        ...
        # if you have archived repo data, add it here
